<?php
	...
	{   
        ...
        if(preg_match_all($pattern_email, $input, $output) )
        {
			$value=array(array('email','mock_test_tbl','email','Name as name,Id,Email as email,Phone as phone,Gender as gender','Id'));
		}else{
